...
LENGTH_INSTRUCTIONS = {
    ...
    "- NEVER write 'End of Part', 'To be continued', 'Next sections will continue'\n"
    "- NEVER add page break notes, continuation messages, or part numbers\n"
    "- NEVER stop mid-document — write the ENTIRE document in ONE response\n"
    "- NEVER use placeholders like [COMPANY NAME], [DATE], [TBD]\n"
    "- NEVER create sections shorter than 200 words\n"
    "- NEVER skip any required section\n"
    "- NEVER use abbreviated or summary content\n"
    "- NEVER include incomplete policies\n"
    "\n"
    "STRUCTURE & ORGANIZATION:\n"
    "- 8 major parts with 70+ numbered sections\n"
    "- Include cover page, table of contents, appendices\n"
    ...
    "\n"
    "QUALITY STANDARDS:\n"
    "- ZERO placeholders — use actual company name and real data provided\n"
    "- Professional formatting and visual hierarchy\n"
    "- Comprehensive yet readable\n"
    "- Legally compliant language and best practices\n"
    "\n"
    "COMPLETION RULE:\n"
    "- Total output: 13,000-15,000 words across 35-40 pages\n"
    "- All 8 parts MUST be fully written\n"
    "- If approaching token limit, shorten each remaining section slightly\n"
    "- but NEVER stop, NEVER add continuation notes, ALWAYS finish the document\n"
    "- The last line of the document must be the Revision History, not a continuation note\n"
),
}
